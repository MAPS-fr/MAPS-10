...
to setup
  ...
  setup-patches
  reset-ticks
  set sugar_in_word sum [food] of patches
end
...
@#$#@#$#@
<experiments>
  <experiment name="experimental" repetitions="20" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <exitCondition>sugar_in_word &lt;= 0</exitCondition>
    <metric>sugar_in_word</metric>
    <steppedValueSet variable="evaporation-rate" first="10" step="10" last="100"/>
    <enumeratedValueSet variable="population">
      <value value="150"/>
    </enumeratedValueSet>
    <steppedValueSet variable="diffusion-rate" first="10" step="10" last="100"/>
  </experiment>
</experiments>
@#$#@#$#@
@#$#@#$#@
